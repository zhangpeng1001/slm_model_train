...
def main():
    """主训练函数"""
    # 模型路径
    model_path = r"/mnt/workspace/base_model/bert-base-chinese"

    save_path = r"/mnt/workspace/train_model/bert-base-chinese/data_extraction"
    # 创建训练器
    trainer = DataExtractionTrainer(model_path, save_path)
