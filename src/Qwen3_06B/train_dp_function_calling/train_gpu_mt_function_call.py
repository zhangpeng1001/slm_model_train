...
output_model_path = r"/mnt/workspace/train_model/Qwen3-tool-dp-function-call"
...
class MultiTaskTrainer:
    ...
    def load_model_and_tokenizer(self):
        ...
        peft_config = LoraConfig(
            ...
            target_modules = ["q_proj", "k_proj", "v_proj", "o_proj", "gate_proj", "up_proj", "down_proj"],  # 减少目标模块
            bias="none",
        )
